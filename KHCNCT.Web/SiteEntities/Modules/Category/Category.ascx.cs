...
namespace KHCNCT.SiteEntities.Modules
{
    public partial class Category : BaseControl
    {
        ...
        private void SaveCategory()
        {
            ...
            if (fulIcon.HasFile)
            {
                ...
                string uploadFolder = "~/assets/icons/newscategory";
            ...
            if (e.Row.RowIndex >= 0)
            {
                ...
                if (cate != null)
                {
                    ...
                    if (cate.Level == 1)
                    {
                        ...
                        {
                            lkbToogleHomePage.Text = "Dừng hiển thị trang chủ";
                            lkbToogleHomePage.ForeColor = Color.Red;
                        }
                        else lkbToogleHomePage.Text = "Hiển thị ở trang chủ";
