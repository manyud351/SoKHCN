<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Category.ascx.cs" Inherits="KHCNCT.SiteEntities.Modules.Category" %>
...
<asp:Panel ID="pnlAddNew" runat="server">
    <table style="width: 100%;">
        ...
        <tr>
            <td>
                Hiển thị danh mục cho:
            </td>
            <td>
                &nbsp;
            </td>
            <td>
                <asp:CheckBox ID="ckbSell" runat="server" Text="Chào bán" /> &nbsp;
                <asp:CheckBox ID="ckbBuy" runat="server" Text="Tìm mua" />
            </td>
        </tr>
        <tr>
            <td>
...
<asp:GridView Width="100%" ID="grvCategories" runat="server" 
    ...
    <Columns>
        ...
        <asp:TemplateField HeaderText="Hiển thị trang chủ">
            ...
            <ItemTemplate>
                <asp:Image ID="imgShowInHomePage2" runat="server" ImageUrl="~/images/icon-folder-64.png" Width="16px" Visible='<%# (Eval("ShowInHomePage")!=null) && Convert.ToBoolean(Eval("ShowInHomePage"))%>' />
                <asp:LinkButton ID="lkbToogleHomePage" runat="server" CommandName="ToogleHomePage" CommandArgument='<%# Eval("Id") %>'>  
                </asp:LinkButton>                
            </ItemTemplate>
        </asp:TemplateField>
        <%--<asp:TemplateField HeaderText="Thứ tự">
...
<div style="margin: 10px auto; width: 80%">
    ...
    <br />
        <span class="admin-desc"><b>(*) Hiển thị trang chủ:</b> danh mục được cấu hình hiển thị menu trang chủ thì tin thuộc chuyên mục đó sẽ xuất hiện ở trang chủ. </span>
    </div>
</div>