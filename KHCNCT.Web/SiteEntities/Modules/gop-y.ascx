<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="gop-y.ascx.cs" Inherits="KHCNCT.Web.SiteEntities.Modules.gop_y" %>
...
<div class="feedback">
    ...
    <div class="form-group">
        <label class="col-sm-2 control-label">
            Lĩnh vực góp ý</label>
        <div class="col-sm-10">
            <asp:TextBox ID="txtLinhVuc" runat="server" CssClass="form-control" 
                ValidationGroup="GopY"></asp:TextBox>
        </div>
    </div>
    <div class="form-group">
