...
<script runat="server">
	...
	public override bool CheckAuthentication()
	{
        ...
        if (Session["UserId"] != null && Session["UserId"] != "" && Session["UserId"] != "-1" && Session["GroupId"] != null && Convert.ToInt16(Session["GroupId"]) != (short)KHCNCT.Globals.Enums.Role.UserRole.Guest) return true;
        else return false;
	}
	...
	public override void SetConfig()
	{
        ...
        BaseUrl = (string)Session["CKBaseURL"];
