<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="vbpq_linhvuc.ascx.cs" Inherits="KHCNCT.Web.admin.modules.vbpq_linhvuc" %>
<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<%@ Register src="~/admin/Controls/Editor.ascx" tagname="Editor" tagprefix="uc1" %>
<div id="divUpdate" runat="server">
<strong>CẬP NHẬT LĨNH VỰC VĂN BẢN</strong>
...
<strong>LĨNH VỰC VĂN BẢN PHÁP QUY</strong>
<br />
<asp:LinkButton ID="lkbAddNew" runat="server" onclick="lkbAddNew_Click">Thêm Lĩnh vực văn bản</asp:LinkButton>
    <br /><br />
    <asp:GridView ID="grvCQBH" runat="server" DataKeyNames="Id" 
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="Sửa">
                <ItemTemplate>
                    <asp:HyperLink ID="lkbEdit" runat="server" NavigateUrl='<%# KHCNCT.Globals.Common.GenerateAdminUrl("vbpq_linhvuc","act=update", "idlv=" + Eval("Id").ToString()) %> '>
            ...
            <asp:TemplateField HeaderText="Xóa">
                <ItemTemplate>
                    <asp:LinkButton ID="lkbDelete" runat="server" OnClientClick="return confirm('Bạn có chắc muốn xóa lĩnh vực này chứ?')" CommandName="Delete">
