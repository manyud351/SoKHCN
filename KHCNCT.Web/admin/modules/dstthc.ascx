<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="dstthc.ascx.cs" Inherits="KHCNCT.Web.admin.modules.dstthc" %>
<asp:Button ID="btnAddNew" runat="server" Text="Thêm mới thủ tục hành chính" 
    onclick="btnAddNew_Click" />
<br />
<br />
<strong>DANH SÁCH THỦ TỤC HÀNH CHÍNH</strong>
<asp:GridView ID="grvThuTuc" runat="server" AutoGenerateColumns="False" 
    ...
    ForeColor="#333333" GridLines="None" onrowdeleting="grvThuTuc_RowDeleting">
        ...
        <Columns>
            <asp:TemplateField>
                <ItemTemplate>
                    <asp:HyperLink ID="hplEdit" runat="server" NavigateUrl='<%# KHCNCT.Globals.Common.GenerateAdminUrl("tthc", "ttid=" + Eval("Id").ToString()) %>'>Sửa</asp:HyperLink>
